...
public class FeatureAccess {
	...
	private static final String INSERT_FEATURESXFEATUREARTEFACTS_SQL = "INSERT INTO featuresxfeatureartefacts(featureid, featureartefactid) VALUES(?, ?)";
	private static final String DELETE_FEATURESXFEATUREARTEFACTS_FEATURE_SQL = "DELETE FROM featuresxfeatureartefacts WHERE featureid = ?";
	private static final String DELETE_FEATURESXFEATUREARTEFACTS_FEATUREARTEFACT_SQL = "DELETE FROM featuresxfeatureartefacts WHERE featureartefactid = ?";
