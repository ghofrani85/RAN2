...
public class VideoFile extends File {
	 ...
	 * @param start The start time of the video file
	 * @param end The end time of the video file
	 */
	public VideoFile(Integer id, String title, Asset asset, String start, String end) {
